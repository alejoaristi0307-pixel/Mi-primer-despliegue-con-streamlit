...
Original file is located at
    https://colab.research.google.com/drive/1R3QhUu7GNnkwm20QvKcLeZbeyciwPM75
...
# Como use arbol no tengo que normalizar
# Pero en el caso que sea otro tipo:
...
#Pegarle la prediccion a la base
data['Prediccion']=Y_pred
data.head()

data

#Celda de codigo con adverntencia de error
